...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			series5->LegendText = L"diskr. function";
			...
			this->label12->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 9.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->label12->Location = System::Drawing::Point(238, 71);
...
#pragma endregion
	...
	// способ 2
	//int n1_pr1 = 3, n1_pr2 = 4; // номера признаков для 1-го узла
	//int n2_pr1 = 4, n2_pr2 = 7; // номера признаков для 2-го узла
	//int n3_pr1 = 0, n3_pr2 = 3; // номера признаков для 3-го узла
	//
	//double n1_c1 = -88.41, n1_c2 = -2.24;  // значения параметров c1 и c2 для узла 1 соответсвенно
	//double n2_c1 = 47.79, n2_c2 = -0.09;   // значения параметров c1 и c2 для узла 2 соответсвенно
	//double n3_c1 = -86.26, n3_c2 = -2.09;  // значения параметров c1 и c2 для узла 3 соответсвенно
	//
	//int m1_cl1_pr1 = 40.27, m1_cl1_pr2 = 73.67; // среднее значение признаков класса 1 для 1-го узла
	//int m2_cl1_pr1 = 54.80, m2_cl1_pr2 = 57.60; // среднее значение признаков класса 1 для 2-го узла
	//int m3_cl1_pr1 = 16.53, m3_cl1_pr2 = 60.07; // среднее значение признаков класса 1 для 3-го узла
	//
	//int m1_cl2_pr1 = 52.36, m1_cl2_pr2 = 46.58; // среднее значение признаков класса 2 для 1-го узла
	//int m2_cl2_pr1 = 51.13, m2_cl2_pr2 = 41.07; // среднее значение признаков класса 2 для 2-го узла
	//int m3_cl2_pr1 = 25.07, m3_cl2_pr2 = 42.20; // среднее значение признаков класса 2 для 3-го узла
	
	// способ 1
	int n1_pr1 = 0, n1_pr2 = 4; // номера признаков для 1-го узла
	int n2_pr1 = 3, n2_pr2 = 4; // номера признаков для 2-го узла
	int n3_pr1 = 3, n3_pr2 = 8; // номера признаков для 3-го узла
	
	double n1_c1 = 151.2, n1_c2 = 2.01; // значения параметров c1 и c2 для узла 1 соответсвенно
	double n2_c1 = 275.42, n2_c2 = 4.51; // значения параметров c1 и c2 для узла 2 соответсвенно
	double n3_c1 = 25.74, n3_c2 = -0.7; // значения параметров c1 и c2 для узла 3 соответсвенно
	
	int m1_cl1_pr1 = 37.00, m1_cl1_pr2 = 73.67; // среднее значение признаков класса 1 для 1-го узла
	int m2_cl1_pr1 = 54.80, m2_cl1_pr2 = 57.60; // среднее значение признаков класса 1 для 2-го узла
	int m3_cl1_pr1 = 60.07, m3_cl1_pr2 = 29.93; // среднее значение признаков класса 1 для 3-го узла
	
	int m1_cl2_pr1 = 23.53, m1_cl2_pr2 = 46.58; // среднее значение признаков класса 2 для 1-го узла
	int m2_cl2_pr1 = 51.13, m2_cl2_pr2 = 41.07; // среднее значение признаков класса 2 для 2-го узла
	int m3_cl2_pr1 = 42.20, m3_cl2_pr2 = 42.47; // среднее значение признаков класса 2 для 3-го узла
